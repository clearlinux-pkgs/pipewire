...
Version  : 1.2.0
Release  : 113
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.0/pipewire-1.2.0.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.0/pipewire-1.2.0.tar.gz
...
%prep
%setup -q -n pipewire-1.2.0
cd %{_builddir}/pipewire-1.2.0
pushd ..
cp -a pipewire-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719503703
...
/V3/usr/lib64/libpipewire-0.3.so.0.1200.0
...
/usr/lib64/libpipewire-0.3.so.0.1200.0
