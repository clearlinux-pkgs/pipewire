...
Version  : 0.3.55
Release  : 57
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.55/pipewire-0.3.55.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.55/pipewire-0.3.55.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657637011
...
cp %{_builddir}/pipewire-0.3.55/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.55/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/b20949a01ecd5fc139d843db8a3e3b66b6ab8623
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.355.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.355.0
