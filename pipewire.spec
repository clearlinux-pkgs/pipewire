...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643299150
...
cp %{_builddir}/pipewire-0.3.44/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.44/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/b20949a01ecd5fc139d843db8a3e3b66b6ab8623
...
/usr/lib64/libpipewire-0.3.so.0.344.0
