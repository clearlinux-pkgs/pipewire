...
%prep
%setup -q -n pipewire-0.3.74
cd %{_builddir}/pipewire-0.3.74
pushd ..
cp -a pipewire-0.3.74 buildavx2
popd
...
/V3/usr/lib64/libpipewire-0.3.so.0.374.0
...
/usr/lib64/libpipewire-0.3.so.0.374.0
