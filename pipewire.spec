...
Version  : 0.3.64
Release  : 74
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.64/pipewire-0.3.64.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.64/pipewire-0.3.64.tar.gz
...
%prep
%setup -q -n pipewire-0.3.64
cd %{_builddir}/pipewire-0.3.64
pushd ..
cp -a pipewire-0.3.64 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673547188
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.364.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.364.0
