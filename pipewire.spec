...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.57/pipewire-0.3.57.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662134991
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.357.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.357.0
