...
Version  : 0.3.47
Release  : 44
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.47/pipewire-0.3.47.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.47/pipewire-0.3.47.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645211860
...
cp %{_builddir}/pipewire-0.3.47/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.47/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/b20949a01ecd5fc139d843db8a3e3b66b6ab8623
...
/usr/lib64/libpipewire-0.3.so.0.347.0
