...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.66/pipewire-0.3.66.tar.gz
...
%prep
%setup -q -n pipewire-0.3.66
cd %{_builddir}/pipewire-0.3.66
pushd ..
cp -a pipewire-0.3.66 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676571636
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.366.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.366.0
