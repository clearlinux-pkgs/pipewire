...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.7/pipewire-1.2.7.tar.gz
...
%prep
%setup -q -n pipewire-1.2.7
cd %{_builddir}/pipewire-1.2.7
pushd ..
cp -a pipewire-1.2.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732635525
...
/V3/usr/lib64/libpipewire-0.3.so.0.1207.0
...
/usr/lib64/libpipewire-0.3.so.0.1207.0
