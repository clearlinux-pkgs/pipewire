...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.62/pipewire-0.3.62.tar.gz
...
%prep
%setup -q -n pipewire-0.3.62
cd %{_builddir}/pipewire-0.3.62
pushd ..
cp -a pipewire-0.3.62 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670877041
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.362.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.362.0
