...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.84/pipewire-0.3.84.tar.gz
...
%prep
%setup -q -n pipewire-0.3.84
cd %{_builddir}/pipewire-0.3.84
pushd ..
cp -a pipewire-0.3.84 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698935535
...
/V3/usr/lib64/libpipewire-0.3.so.0.384.0
...
/usr/lib64/libpipewire-0.3.so.0.384.0
