...
Version  : 1.2.2
Release  : 115
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.2/pipewire-1.2.2.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.2/pipewire-1.2.2.tar.gz
...
%prep
%setup -q -n pipewire-1.2.2
cd %{_builddir}/pipewire-1.2.2
pushd ..
cp -a pipewire-1.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722440394
...
/V3/usr/lib64/libpipewire-0.3.so.0.1202.0
...
/usr/lib64/libpipewire-0.3.so.0.1202.0
