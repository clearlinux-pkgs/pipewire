...
Version  : 0.3.61
Release  : 70
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.61/pipewire-0.3.61.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.61/pipewire-0.3.61.tar.gz
...
%prep
%setup -q -n pipewire-0.3.61
cd %{_builddir}/pipewire-0.3.61
pushd ..
cp -a pipewire-0.3.61 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669395961
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.361.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.361.0
