...
Version  : 1.2.5
Release  : 119
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.5/pipewire-1.2.5.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.5/pipewire-1.2.5.tar.gz
...
%prep
%setup -q -n pipewire-1.2.5
cd %{_builddir}/pipewire-1.2.5
pushd ..
cp -a pipewire-1.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727471926
...
/V3/usr/lib64/libpipewire-0.3.so.0.1205.0
...
/usr/lib64/libpipewire-0.3.so.0.1205.0
