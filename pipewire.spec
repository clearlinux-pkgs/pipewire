...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.4.3/pipewire-1.4.3.tar.gz
...
%prep
%setup -q -n pipewire-1.4.3
cd %{_builddir}/pipewire-1.4.3
pushd ..
cp -a pipewire-1.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747922762
...
/V3/usr/lib64/libpipewire-0.3.so.0.1403.0
...
/usr/lib64/libpipewire-0.3.so.0.1403.0
