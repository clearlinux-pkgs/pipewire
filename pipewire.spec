...
Version  : 0.3.60
Release  : 69
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.60/pipewire-0.3.60.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.60/pipewire-0.3.60.tar.gz
...
%prep
%setup -q -n pipewire-0.3.60
cd %{_builddir}/pipewire-0.3.60
pushd ..
cp -a pipewire-0.3.60 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668095901
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.360.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.360.0
