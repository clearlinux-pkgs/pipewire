...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.0.4/pipewire-1.0.4.tar.gz
...
%prep
%setup -q -n pipewire-1.0.4
cd %{_builddir}/pipewire-1.0.4
pushd ..
cp -a pipewire-1.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710538466
...
/V3/usr/lib64/libpipewire-0.3.so.0.1004.0
...
/usr/lib64/libpipewire-0.3.so.0.1004.0
