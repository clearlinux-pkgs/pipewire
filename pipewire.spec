...
Version  : 0.3.65
Release  : 75
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.65/pipewire-0.3.65.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.65/pipewire-0.3.65.tar.gz
...
%prep
%setup -q -n pipewire-0.3.65
cd %{_builddir}/pipewire-0.3.65
pushd ..
cp -a pipewire-0.3.65 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674749285
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpipewire-0.3.so.0.365.0
/usr/lib64/gstreamer-1.0/libgstpipewire.so
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.365.0
