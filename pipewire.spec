...
Version  : 1.2.6
Release  : 120
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.6/pipewire-1.2.6.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.2.6/pipewire-1.2.6.tar.gz
...
%prep
%setup -q -n pipewire-1.2.6
cd %{_builddir}/pipewire-1.2.6
pushd ..
cp -a pipewire-1.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729693370
...
/V3/usr/lib64/libpipewire-0.3.so.0.1206.0
...
/usr/lib64/libpipewire-0.3.so.0.1206.0
