...
Version  : 1.0.1
Release  : 107
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.0.1/pipewire-1.0.1.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.0.1/pipewire-1.0.1.tar.gz
...
%prep
%setup -q -n pipewire-1.0.1
cd %{_builddir}/pipewire-1.0.1
pushd ..
cp -a pipewire-1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704985965
...
/V3/usr/lib64/libpipewire-0.3.so.0.1001.0
...
/usr/lib64/libpipewire-0.3.so.0.1001.0
