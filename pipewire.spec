...
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.4.2/pipewire-1.4.2.tar.gz
...
%prep
%setup -q -n pipewire-1.4.2
cd %{_builddir}/pipewire-1.4.2
pushd ..
cp -a pipewire-1.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744637789
...
/V3/usr/lib64/libpipewire-0.3.so.0.1402.0
...
/usr/lib64/libpipewire-0.3.so.0.1402.0
